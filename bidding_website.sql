...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2023 at 07:17 PM
...
INSERT INTO `autions` (`id`, `title`, `categorey_name`, `type`, `age`, `height`, `description`, `weight`, `price`, `image`, `start_date`, `end_data`, `status`) VALUES
(1, 'Rosie', 'Mustang', 'Ranch Horse', '6 years', '15 hands', 'Rosie, a hardy Mustang, is an invaluable asset on the ranch, displaying intelligence and versatility in herding cattle and navigating rugged terrain', '1100 lbs', '4200', '1693384436.jpg', '2022-11-23', '2024-03-07', 'Active'),
(2, 'Chief', 'Belgian Draft', 'Workhorse', '9 years', '17.3 hands', 'Chief, a robust Belgian Draft horse, is a true workhorse, capable of pulling heavy loads with his impressive strength and gentle temperament', '2000 lbs', '7500', '1693384523.jpg', '2023-04-17', '2024-01-02', 'Active'),
(3, 'Whisper', 'Endurance Horse', 'Workhorse', '7 years', '15.2 hands', 'Whisper, an agile Arabian, conquers endurance races with its unwavering stamina and deep connection with its rider', '950 lbs', '10500', '1693384642.jpg', '2023-03-15', '2024-05-29', 'Active'),
(4, 'Zeus', 'Clydesdale', 'Show Hitch', '4 years', '18 hands', 'Zeus, a majestic Clydesdale, steals the show in elaborate hitches, displaying strength and elegance while pulling ornate wagons', '2200 lbs', '25000', '1693384712.jpg', '2023-08-09', '2023-10-18', 'Active'),
(5, 'Misty', 'Welsh Pony', 'Children\'s Pony', '10 years', '12.1 hands', 'Misty, an adorable Welsh Pony, brings joy to children with its manageable size and gentle nature, making it an ideal first pony', '450 lbs', '3000', '1693384772.jpg', '2023-08-01', '2023-12-26', 'Active'),
(6, 'Tango', 'Paso Fino', 'Gaited Horse', '5 years', '14.3 hands', 'Tango, a charismatic Paso Fino, wows riders with its unique and smooth four-beat gait, providing a comfortable ride', '1000 lbs', '6200', '1693384834.jpg', '2023-08-09', '2023-10-31', 'Active'),
(7, 'Maverick', 'American Quarter Horse', 'Cutting Horse', '8 years', '15.1 hands', 'Maverick, an agile American Quarter Horse, showcases exceptional cow sense and quick reflexes, making it a standout in cutting competitions', '1200 lbs', '7800', '1693384901.jpg', '2023-08-17', '2023-11-07', 'Active'),
(8, 'Serenity', 'Morgan', 'All-Around Horse', '11 years', '14.3 hands', 'Serenity, a versatile Morgan horse, lives up to its breed\'s reputation by excelling in various disciplines, from trail riding to dressage, with a calm and adaptable nature.', '1100 lbs', '5000', '1693384961.jpg', '2023-08-02', '2023-11-23', 'Active');
...
(4, 7, 'Maverick', 'cancel', '3', 7800, '300', NULL, NULL, '2023-08-31 08:35:26', '2023-08-31 09:18:32'),
(5, 3, 'Whisper', 'approved', '3', 10500, '7777', NULL, NULL, '2023-08-31 08:41:55', '2023-08-31 09:18:28'),
(6, 2, 'Chief', NULL, '3', 7500, '12', NULL, NULL, '2023-08-31 09:13:52', '2023-08-31 09:13:52');
...
(2, 'rana muzamil1', 'User', 'muzamil@gmail.com', NULL, '$2y$10$8oP1zQBFmFM9yGHVWLO/dOIRWkhSRVRfCChJC/z5xSo.daVc5NHQ2', NULL, '2023-07-12 18:41:50', '2023-08-31 06:14:30'),
(3, 'gujjar', 'admin', 'umair@gmail.com', NULL, '$2y$10$pE/AHiO1oAEPW8pZotajseVBZcH3LDAEH7qATjzT0SfDGElvUN.FK', NULL, '2023-08-17 07:19:52', '2023-08-17 07:19:52'),
(4, 'dani', 'user', 'dani@gmail.com', NULL, '$2y$10$Q4Jh375HQIJDXujg0/I/KedmFO8gP/NmBlwHCwf3Wpu.jd2dGJ7qe', NULL, '2023-08-17 08:10:48', '2023-08-17 08:10:48'),
(5, 'zabi', 'admin', 'zabi@gmail.com', NULL, '$2y$10$/aA5Yzv00g4IMdReg1q4ge6oq.P0iM2UCGuV085VU.gopZM/6Sbcm', NULL, '2023-08-17 08:11:22', '2023-08-17 08:11:22');
